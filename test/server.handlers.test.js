...
test('všechny moduly dohromady pokrývají 74 unikátních eventů', () => {
    const all = [];
    ...
    assert.equal(new Set(all).size, 74, 'žádný event se nesmí registrovat dvakrát');
});
