...
- **Postavy 34–41** jsou v `characters.json` i jako `WILD_WEST_CHARACTERS`
  ...
  debug hra dál všech osm. Chybí Lee Van Kliff (fáze 6) a Greygory Deck (10).
