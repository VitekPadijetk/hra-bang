...
## Rozšíření Zlatá horečka (Gold Rush) — hotové fáze 0 a 1 z 8
...
**Hotová je fáze 0 (měna) a fáze 1 (obchod).** Rozšíření jde zapnout (běžná hra / hra
botů / debug), valouny přibývají, kupuje se z obchodu, vybavení leží před hráčem a Pivo
jde vyměnit za valoun. Karty s ještě nenapsaným efektem se do balíčku vůbec nerozdávají
(`GEAR_READY`), takže se ve fázi 1 prodává **Panák** a **Union Pacific**; ostatní druhy
i všech 8 postav přijdou ve fázích 2–6.
...
- **Ztráta života má v kódu tři vstupy**, proto přibyl trychtýř
  **`_afterLifeLost(playerIdx, { attackerIdx, last })`** ([logic/goldRush.js](logic/goldRush.js)),
  ...
  zdroje, takže bez něj by tiše nefungovaly zrovna na dynamitu (rozhodnutí R5). Tělo plní
  fáze 2 a 6 — schopnosti přibývají DO NĚHO, ne k volajícím. `last: true` vypíná Boty
  i Talisman („neúčinkují při ztrátě posledního života"), Simeona Picose ne.
