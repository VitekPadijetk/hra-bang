...
## Rozšíření Zlatá horečka (Gold Rush) — hotové fáze 0–4 z 8
...
(placené černé vybavení) a fáze 4 (hnědé karty s volbou).**
Rozšíření jde zapnout (běžná hra / hra botů / debug), valouny přibývají, kupuje se
z obchodu, vybavení leží před hráčem a Pivo jde vyměnit za valoun. Karty s ještě
nenapsaným efektem se do balíčku vůbec nerozdávají (`GEAR_READY`), takže se dnes prodává
**Panák**, **Union Pacific**, **Boty**, **Talisman**, **Nábojový pás**, **Krumpáč**, **Kalumet**,
**Podkova**, **Rýžovací mísa**, **Batoh**, **Láhev**, **Komplic**, **Rum** a **Zlatá horečka**
(14 druhů z 15); chybí jen **Wanted** (fáze 5) a všech 8 postav (fáze 6).
...
- **Fáze `GEAR_TARGET`** (Panák: „hráč dle tvé volby, i ty"; cílené režimy Láhve a Komplice)
  je jediná fáze, kterou obchod má — nákup sám fází NENÍ (rozhodnutí R6). Cíl se vybírá
  klikem na postavu soupeře (stejný vzor jako Pokrevní bratři); na SEBE je tlačítko, protože
  vlastní portrét se v mojí zóně neklika.
