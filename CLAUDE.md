...
- **Postavy 34–41** jsou v `characters.json` i jako `WILD_WEST_CHARACTERS`
  ...
  Big Spencer, Flint Westwood, Gary Looter, John Pain, Youl Grinner), debug hra dál
  všech osm. Chybí Teren Kill (fáze 5), Lee Van Kliff (6) a Greygory Deck (10).
