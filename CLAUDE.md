...
- **Postavy 34–41** jsou v `characters.json` i jako `WILD_WEST_CHARACTERS`
  ([logic/entities.js](logic/entities.js)) a portréty jsou hotové, ale do `_characterPool`
  se **zatím nepřidávají** — nemají schopnosti ani životy (Big Spencer 9, Gary Looter 5).
