...
| `core/menuModel.js` | `esc`, `waitingGamesLabel`/`runningGamesLabel`, `initialsOf`, `clampName`/`nameError`, … | **čistá logika nového menu** (texty, skloňování, zamčení tlačítek) – testy `test/menuModel.test.js`. |
