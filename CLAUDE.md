...
## Rozšíření Zlatá horečka (Gold Rush) — hotové fáze 0–5 z 8
...
(placené černé vybavení), fáze 4 (hnědé karty s volbou) a fáze 5 (Wanted).**
Rozšíření jde zapnout (běžná hra / hra botů / debug), valouny přibývají, kupuje se
z obchodu, vybavení leží před hráčem a Pivo jde vyměnit za valoun. **Všech 15 druhů karet
vybavení (24 kusů) je hotových**, takže `GEAR_READY` je dnes celý seznam a zůstává jen jako
pojistka pro další rozšíření (vzor `WILD_WEST_READY`). Chybí už jen **8 postav** (fáze 6)
a **Stínoví pistolníci** (fáze 7, volitelná varianta).
